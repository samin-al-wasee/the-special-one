...
class PlayerRepository {
  ...
  Future<List<Map<String, dynamic>>> getAllPlayersWithCountryAndContinent() async {
  ...
  Future<List<Map<String, dynamic>>> getPlayersByPositionWithCountry(Position position) async {
