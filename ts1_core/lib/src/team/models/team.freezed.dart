...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is Team&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.tactic, tactic) || other.tactic == tactic)&&(identical(other.lineup, lineup) || other.lineup == lineup)&&const DeepCollectionEquality().equals(other.squad, squad));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,tactic,lineup,const DeepCollectionEquality().hash(squad));

@override
String toString() {
  return 'Team(id: $id, name: $name, tactic: $tactic, lineup: $lineup, squad: $squad)';
}
...
/// Create a copy of Team
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? name = null,Object? tactic = null,Object? lineup = null,Object? squad = null,}) {
...
class _Team extends Team {
  const _Team({required this.id, required this.name, required this.tactic, required this.lineup, final  List<Player> squad = const []}): _squad = squad,super._();
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _Team&&(identical(other.id, id) || other.id == id)&&(identical(other.name, name) || other.name == name)&&(identical(other.tactic, tactic) || other.tactic == tactic)&&(identical(other.lineup, lineup) || other.lineup == lineup)&&const DeepCollectionEquality().equals(other._squad, _squad));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,name,tactic,lineup,const DeepCollectionEquality().hash(_squad));
...
/// Create a copy of Team
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? name = null,Object? tactic = null,Object? lineup = null,Object? squad = null,}) {
  return _then(_Team(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,name: null == name ? _self.name : name // ignore: cast_nullable_to_non_nullable
as String,tactic: null == tactic ? _self.tactic : tactic // ignore: cast_nullable_to_non_nullable
