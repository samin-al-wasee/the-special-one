...
mixin _$TeamLineup {
 ...
 int get id; FormationShape get formationShape; List<LineupSlotAssignment> get slotAssignments; List<Player> get bench; List<Player> get reserves; Player? get captain;
...
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is TeamLineup&&(identical(other.id, id) || other.id == id)&&(identical(other.formationShape, formationShape) || other.formationShape == formationShape)&&const DeepCollectionEquality().equals(other.slotAssignments, slotAssignments)&&const DeepCollectionEquality().equals(other.bench, bench)&&const DeepCollectionEquality().equals(other.reserves, reserves)&&(identical(other.captain, captain) || other.captain == captain));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,formationShape,const DeepCollectionEquality().hash(slotAssignments),const DeepCollectionEquality().hash(bench),const DeepCollectionEquality().hash(reserves),captain);

@override
String toString() {
  return 'TeamLineup(id: $id, formationShape: $formationShape, slotAssignments: $slotAssignments, bench: $bench, reserves: $reserves, captain: $captain)';
}
...
@useResult
$Res call({
 int id, FormationShape formationShape, List<LineupSlotAssignment> slotAssignments, List<Player> bench, List<Player> reserves, Player? captain
});


$FormationShapeCopyWith<$Res> get formationShape;$PlayerCopyWith<$Res>? get captain;
...
/// Create a copy of TeamLineup
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? formationShape = null,Object? slotAssignments = null,Object? bench = null,Object? reserves = null,Object? captain = freezed,}) {
  return _then(_self.copyWith(
id: null == id ? _self.id : id // ignore: cast_nullable_to_non_nullable
as int,formationShape: null == formationShape ? _self.formationShape : formationShape // ignore: cast_nullable_to_non_nullable
...
@override
@pragma('vm:prefer-inline')
$FormationShapeCopyWith<$Res> get formationShape {
  
  return $FormationShapeCopyWith<$Res>(_self.formationShape, (value) {
    return _then(_self.copyWith(formationShape: value));
  });
}/// Create a copy of TeamLineup
/// with the given fields replaced by the non-null parameter values.
@override
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( int id,  FormationShape formationShape,  List<LineupSlotAssignment> slotAssignments,  List<Player> bench,  List<Player> reserves,  Player? captain)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _TeamLineup() when $default != null:
return $default(_that.id,_that.formationShape,_that.slotAssignments,_that.bench,_that.reserves,_that.captain);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( int id,  FormationShape formationShape,  List<LineupSlotAssignment> slotAssignments,  List<Player> bench,  List<Player> reserves,  Player? captain)  $default,) {final _that = this;
switch (_that) {
case _TeamLineup():
return $default(_that.id,_that.formationShape,_that.slotAssignments,_that.bench,_that.reserves,_that.captain);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( int id,  FormationShape formationShape,  List<LineupSlotAssignment> slotAssignments,  List<Player> bench,  List<Player> reserves,  Player? captain)?  $default,) {final _that = this;
switch (_that) {
case _TeamLineup() when $default != null:
return $default(_that.id,_that.formationShape,_that.slotAssignments,_that.bench,_that.reserves,_that.captain);case _:
  return null;
...
class _TeamLineup extends TeamLineup {
  const _TeamLineup({required this.id, required this.formationShape, final  List<LineupSlotAssignment> slotAssignments = const [], final  List<Player> bench = const [], final  List<Player> reserves = const [], this.captain}): _slotAssignments = slotAssignments,_bench = bench,_reserves = reserves,super._();
  factory _TeamLineup.fromJson(Map<String, dynamic> json) => _$TeamLineupFromJson(json);

@override final  int id;
@override final  FormationShape formationShape;
...
@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _TeamLineup&&(identical(other.id, id) || other.id == id)&&(identical(other.formationShape, formationShape) || other.formationShape == formationShape)&&const DeepCollectionEquality().equals(other._slotAssignments, _slotAssignments)&&const DeepCollectionEquality().equals(other._bench, _bench)&&const DeepCollectionEquality().equals(other._reserves, _reserves)&&(identical(other.captain, captain) || other.captain == captain));
}

@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,formationShape,const DeepCollectionEquality().hash(_slotAssignments),const DeepCollectionEquality().hash(_bench),const DeepCollectionEquality().hash(_reserves),captain);
...
@override $FormationShapeCopyWith<$Res> get formationShape;@override $PlayerCopyWith<$Res>? get captain;
...
/// Create a copy of TeamLineup
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? formationShape = null,Object? slotAssignments = null,Object? bench = null,Object? reserves = null,Object? captain = freezed,}) {
