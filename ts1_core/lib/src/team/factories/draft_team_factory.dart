...
class DraftTeamFactory {
  ...
  static final List<_PlayerSeed> _southAmericanAllStars = [
    _PlayerSeed('Dida', Position.goalKeeper, Footedness.right, DateTime(1973, 10, 7), 195, 85),
    _PlayerSeed('Claudio Taffarel', Position.goalKeeper, Footedness.right, DateTime(1966, 5, 8), 181, 79),
    _PlayerSeed('Carlos Alberto Torres', Position.rightBack, Footedness.right, DateTime(1944, 7, 17), 180, 75),
    _PlayerSeed('Cafu', Position.rightBack, Footedness.right, DateTime(1970, 6, 7), 176, 73),
    _PlayerSeed('Roberto Carlos', Position.leftBack, Footedness.left, DateTime(1973, 4, 10), 168, 70),
    _PlayerSeed('Nilton Santos', Position.leftBack, Footedness.left, DateTime(1925, 5, 16), 181, 74),
    _PlayerSeed('Daniel Passarella', Position.centerBack, Footedness.right, DateTime(1953, 5, 25), 174, 73),
    _PlayerSeed('Elias Figueroa', Position.centerBack, Footedness.right, DateTime(1946, 10, 25), 182, 78),
    _PlayerSeed('Thiago Silva', Position.centerBack, Footedness.right, DateTime(1984, 9, 22), 183, 79),
    _PlayerSeed('Lucio', Position.centerBack, Footedness.right, DateTime(1978, 5, 8), 188, 84),
    _PlayerSeed('Javier Mascherano', Position.defensiveMidfielder, Footedness.right, DateTime(1984, 6, 8), 174, 73),
    _PlayerSeed('Fernando Redondo', Position.defensiveMidfielder, Footedness.left, DateTime(1969, 6, 6), 186, 80),
    _PlayerSeed('Socrates', Position.centralMidfielder, Footedness.right, DateTime(1954, 2, 19), 192, 84),
    _PlayerSeed('Carlos Valderrama', Position.centralMidfielder, Footedness.right, DateTime(1961, 9, 2), 175, 74),
    _PlayerSeed('Zico', Position.attackingMidfielder, Footedness.right, DateTime(1953, 3, 3), 172, 70),
    _PlayerSeed('Juan Roman Riquelme', Position.attackingMidfielder, Footedness.right, DateTime(1978, 6, 24), 182, 78),
    _PlayerSeed('Lionel Messi', Position.rightWinger, Footedness.left, DateTime(1987, 6, 24), 170, 72),
    _PlayerSeed('Garrincha', Position.rightWinger, Footedness.right, DateTime(1933, 10, 28), 169, 69),
    _PlayerSeed('Neymar', Position.leftWinger, Footedness.right, DateTime(1992, 2, 5), 175, 68),
    _PlayerSeed('Ronaldinho', Position.leftWinger, Footedness.right, DateTime(1980, 3, 21), 181, 80),
    _PlayerSeed('Pele', Position.striker, Footedness.right, DateTime(1940, 10, 23), 173, 70),
    _PlayerSeed('Ronaldo Nazario', Position.striker, Footedness.right, DateTime(1976, 9, 18), 183, 82),
    _PlayerSeed('Romario', Position.striker, Footedness.right, DateTime(1966, 1, 29), 169, 72),
    _PlayerSeed('Gabriel Batistuta', Position.striker, Footedness.right, DateTime(1969, 2, 1), 185, 80),
  ];

  static final List<_PlayerSeed> _europeanAllStars = [
    _PlayerSeed('Gianluigi Buffon', Position.goalKeeper, Footedness.right, DateTime(1978, 1, 28), 191, 83),
    _PlayerSeed('Manuel Neuer', Position.goalKeeper, Footedness.right, DateTime(1986, 3, 27), 193, 92),
    _PlayerSeed('Philipp Lahm', Position.rightBack, Footedness.right, DateTime(1983, 11, 11), 170, 66),
    _PlayerSeed('Dani Carvajal', Position.rightBack, Footedness.right, DateTime(1992, 1, 11), 173, 73),
    _PlayerSeed('Paolo Maldini', Position.leftBack, Footedness.left, DateTime(1968, 6, 26), 186, 80),
    _PlayerSeed('Ashley Cole', Position.leftBack, Footedness.left, DateTime(1980, 12, 20), 176, 66),
    _PlayerSeed('Franz Beckenbauer', Position.centerBack, Footedness.right, DateTime(1945, 9, 11), 181, 76),
    _PlayerSeed('Franco Baresi', Position.centerBack, Footedness.right, DateTime(1960, 5, 8), 176, 70),
    _PlayerSeed('Sergio Ramos', Position.centerBack, Footedness.right, DateTime(1986, 3, 30), 184, 82),
    _PlayerSeed('Fabio Cannavaro', Position.centerBack, Footedness.right, DateTime(1973, 9, 13), 176, 75),
    _PlayerSeed('Claude Makelele', Position.defensiveMidfielder, Footedness.right, DateTime(1973, 2, 18), 174, 70),
    _PlayerSeed('Sergio Busquets', Position.defensiveMidfielder, Footedness.right, DateTime(1988, 7, 16), 189, 76),
    _PlayerSeed('Luka Modric', Position.centralMidfielder, Footedness.right, DateTime(1985, 9, 9), 172, 67),
    _PlayerSeed('Andres Iniesta', Position.centralMidfielder, Footedness.right, DateTime(1984, 5, 11), 171, 68),
    _PlayerSeed('Zinedine Zidane', Position.attackingMidfielder, Footedness.right, DateTime(1972, 6, 23), 185, 80),
    _PlayerSeed('Johan Cruyff', Position.attackingMidfielder, Footedness.right, DateTime(1947, 4, 25), 180, 71),
    _PlayerSeed('Luis Figo', Position.rightWinger, Footedness.right, DateTime(1972, 11, 4), 180, 75),
    _PlayerSeed('George Best', Position.rightWinger, Footedness.right, DateTime(1946, 5, 22), 175, 72),
    _PlayerSeed('Cristiano Ronaldo', Position.leftWinger, Footedness.right, DateTime(1985, 2, 5), 187, 84),
    _PlayerSeed('Thierry Henry', Position.leftWinger, Footedness.right, DateTime(1977, 8, 17), 188, 83),
    _PlayerSeed('Marco van Basten', Position.striker, Footedness.right, DateTime(1964, 10, 31), 188, 80),
    _PlayerSeed('Gerd Muller', Position.striker, Footedness.right, DateTime(1945, 11, 3), 176, 75),
    _PlayerSeed('Robert Lewandowski', Position.striker, Footedness.right, DateTime(1988, 8, 21), 185, 81),
    _PlayerSeed('Karim Benzema', Position.striker, Footedness.right, DateTime(1987, 12, 19), 185, 81),
  ];
}
