...
mixin _$MatchDynamics {
 ...
 double get homeMomentum; double get awayMomentum; double get homeConfidence; double get awayConfidence; double get homeFatigue; double get awayFatigue; double get homeDisciplinePressure; double get awayDisciplinePressure; Map<PitchZone, double> get homeZoneDominance; Map<PitchZone, double> get awayZoneDominance; Map<String, int> get exploitationCounters;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,homeMomentum,awayMomentum,homeConfidence,awayConfidence,homeFatigue,awayFatigue,homeDisciplinePressure,awayDisciplinePressure,const DeepCollectionEquality().hash(homeZoneDominance),const DeepCollectionEquality().hash(awayZoneDominance),const DeepCollectionEquality().hash(exploitationCounters));

@override
String toString() {
  return 'MatchDynamics(homeMomentum: $homeMomentum, awayMomentum: $awayMomentum, homeConfidence: $homeConfidence, awayConfidence: $awayConfidence, homeFatigue: $homeFatigue, awayFatigue: $awayFatigue, homeDisciplinePressure: $homeDisciplinePressure, awayDisciplinePressure: $awayDisciplinePressure, homeZoneDominance: $homeZoneDominance, awayZoneDominance: $awayZoneDominance, exploitationCounters: $exploitationCounters)';
}
...
@useResult
$Res call({
 double homeMomentum, double awayMomentum, double homeConfidence, double awayConfidence, double homeFatigue, double awayFatigue, double homeDisciplinePressure, double awayDisciplinePressure, Map<PitchZone, double> homeZoneDominance, Map<PitchZone, double> awayZoneDominance, Map<String, int> exploitationCounters
});
...
/// Create a copy of MatchDynamics
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? homeMomentum = null,Object? awayMomentum = null,Object? homeConfidence = null,Object? awayConfidence = null,Object? homeFatigue = null,Object? awayFatigue = null,Object? homeDisciplinePressure = null,Object? awayDisciplinePressure = null,Object? homeZoneDominance = null,Object? awayZoneDominance = null,Object? exploitationCounters = null,}) {
  return _then(_self.copyWith(
homeMomentum: null == homeMomentum ? _self.homeMomentum : homeMomentum // ignore: cast_nullable_to_non_nullable
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( double homeMomentum,  double awayMomentum,  double homeConfidence,  double awayConfidence,  double homeFatigue,  double awayFatigue,  double homeDisciplinePressure,  double awayDisciplinePressure,  Map<PitchZone, double> homeZoneDominance,  Map<PitchZone, double> awayZoneDominance,  Map<String, int> exploitationCounters)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _MatchDynamics() when $default != null:
return $default(_that.homeMomentum,_that.awayMomentum,_that.homeConfidence,_that.awayConfidence,_that.homeFatigue,_that.awayFatigue,_that.homeDisciplinePressure,_that.awayDisciplinePressure,_that.homeZoneDominance,_that.awayZoneDominance,_that.exploitationCounters);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( double homeMomentum,  double awayMomentum,  double homeConfidence,  double awayConfidence,  double homeFatigue,  double awayFatigue,  double homeDisciplinePressure,  double awayDisciplinePressure,  Map<PitchZone, double> homeZoneDominance,  Map<PitchZone, double> awayZoneDominance,  Map<String, int> exploitationCounters)  $default,) {final _that = this;
switch (_that) {
case _MatchDynamics():
return $default(_that.homeMomentum,_that.awayMomentum,_that.homeConfidence,_that.awayConfidence,_that.homeFatigue,_that.awayFatigue,_that.homeDisciplinePressure,_that.awayDisciplinePressure,_that.homeZoneDominance,_that.awayZoneDominance,_that.exploitationCounters);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( double homeMomentum,  double awayMomentum,  double homeConfidence,  double awayConfidence,  double homeFatigue,  double awayFatigue,  double homeDisciplinePressure,  double awayDisciplinePressure,  Map<PitchZone, double> homeZoneDominance,  Map<PitchZone, double> awayZoneDominance,  Map<String, int> exploitationCounters)?  $default,) {final _that = this;
switch (_that) {
case _MatchDynamics() when $default != null:
return $default(_that.homeMomentum,_that.awayMomentum,_that.homeConfidence,_that.awayConfidence,_that.homeFatigue,_that.awayFatigue,_that.homeDisciplinePressure,_that.awayDisciplinePressure,_that.homeZoneDominance,_that.awayZoneDominance,_that.exploitationCounters);case _:
  return null;
...
/// Create a copy of MatchDynamics
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? homeMomentum = null,Object? awayMomentum = null,Object? homeConfidence = null,Object? awayConfidence = null,Object? homeFatigue = null,Object? awayFatigue = null,Object? homeDisciplinePressure = null,Object? awayDisciplinePressure = null,Object? homeZoneDominance = null,Object? awayZoneDominance = null,Object? exploitationCounters = null,}) {
