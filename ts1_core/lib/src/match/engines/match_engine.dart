...
class MatchEngine {
  ...
  static Match changeTeamFormation({
    ...
    return _updateTeamAndRecalculate(match, side, newTeam);
  }

  /// Changes a team's tactic during a match and updates context/state.
  static Match changeTeamTactic({
    required Match match,
    required TeamSide side,
    required TeamTactic newTactic,
  }) {
    final oldTeam = side == TeamSide.home ? match.homeTeam : match.awayTeam;
    final newTeam = oldTeam.copyWith(tactic: newTactic);
    return _updateTeamAndRecalculate(match, side, newTeam);
  }
  ...
  static Match _updateTeamAndRecalculate(
    ...
    // Rebuild match context, matchup state, and dynamics
    ...
    final newDynamics = MatchDynamicsBuilder.fromContext(
      newContext,
